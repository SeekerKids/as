...
Gui,Font,s14 cWhite
Gui,Add,Radio,x10 y+10 checked vSpasi gupdate,Spasi
Gui,Add,Radio,x10 y+10 vNoSpasi gUPdate, NoSpasi
gui,Font
...
Gui,font,s8 cBlack
Gui,add,edit,x+10 gUPdate w50 vDelay,2500
...
if (mulai == 1){
	...
	if (mulai == 1 && Spasi==1){
			Controlsend,,{enter down}, ahk_pid %Window%
			if (mulai == 1){
				sleep,800
			}
		}
	if (mulai == 1&& Spasi==1){
			Controlsend,,{enter up}, ahk_pid %Window%
			if (mulai == 1){
				sleep,3000
			}
		}
